...
if [ ! -f ./database/hub.db ]; then
    sqlite3 database/hub.db < DIR/scripts/setupDB.sql
    sqlite3 database/hub.db < DIR/scripts/initializeDB.sql
    python DIR/scripts/updatedb.py
fi
